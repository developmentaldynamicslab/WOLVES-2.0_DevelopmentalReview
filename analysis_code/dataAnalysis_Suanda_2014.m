...
%%JPS added this figure from PR -- had to estimate empirical values from PR
%%figure...
figure(312)% Plot Mean proportion correct looking time
blockNames={'High'; 'Moderate'; 'Low'};
sts = [ winnersH./iH 0.8 ;        winnersM./iM 0.68 ;        winnersL./iL 0.58  ];
errY =[ 0.04 0.21/sqrt(28) ; 0.04 0.20/sqrt(28) ; 0.04 0.18 /sqrt(28) ];%28*3 is number of child particpants
b=barwitherr(errY, sts);% Plot with errorbars
set(gca,'xticklabel',blockNames,'fontsize',16)
%legend('Target','Distractor');
ylabel('Prop looking more to target than distractors');
legend('WOLVES Model','Suanda, Mugwanya & Namy, 2014');
ylim([0 1]);
grid on
