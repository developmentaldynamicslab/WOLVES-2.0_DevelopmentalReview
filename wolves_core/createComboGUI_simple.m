...
gui = StandardGUI(sim, [25, 75, 1800, 1000], 0, [0, 0.175, 1.0, 0.8], [8, 12], [0.015, 0.0225], [0, 0, 1.0, 0.05], [1, 6], ...
  elementGroups, elementsInGroup);
...
for i = 1 : nFeatures
  ...
  ov = (3*i)+1; % vertical offset for placing visualizations of the current feature
  
  gui.addVisualization(ScaledImage(['wf' n], 'activation', [-7.5, 7.5], ...
    {'CLim', [-7.5, 7.5], 'YAxisLocation', 'right', 'YDir', 'normal'}, {}, ['word feature' n], xlw), [ov, 1], [3, 3]);
  gui.addVisualization(ScaledImage(['wm_c' n], 'activation', [-7.5, 7.5], ...
    {'CLim', [-7.5, 7.5], 'YAxisLocation', 'right', 'YDir', 'normal'}, {}, ['scene wm' n], xla), [ov, 4], [3, 3]);
